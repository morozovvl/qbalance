...
// Здесь Вы можете вставить свой код
	if (getValue("P1__КОЛ")  == getValue("КР401__КОНКОЛ") + getOldValue("P1__КОЛ"))
		setValue("P1__СУММА", getValue("КР401__КОНСАЛЬДО") + getValue("P1__СУММА"));
	else
		setValue("P1__СУММА", getValue("P1__КОЛ") * getValue("P1__ЦЕНА"));
}
...
// Здесь Вы можете вставить свой код
documents.setValue("КОММЕНТАРИЙ", getDictionary("объекты").getValue("имя"));
}
