...
// Здесь Вы можете вставить свой код
	...
	var общ_кол = getOldValue("P1__КОЛ") + getOldValue("КР401__КОНКОЛ");
	var общ_сумма = getOldValue("P1__СУММА") + getOldValue("КР401__КОНСАЛЬДО");
/*	
	var кол = getValue("P1__КОЛ");
	var цена = getOldValue("P1__ЦЕНА");
