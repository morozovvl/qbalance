...
class orQuery {
  ...
  public:
    ...
    inline bool queryExecuted() const { return (dataSource != 0); }
    bool execute();

    //inline XSqlQuery *getQuery() { return qryQuery; }
    inline IDataSource* getDataSource()                { return dataSource  ; }
    inline void setDataSource(IDataSource* value)      { dataSource = value ; }
