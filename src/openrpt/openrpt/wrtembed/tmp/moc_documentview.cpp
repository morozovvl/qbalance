...
static const char qt_meta_stringdata_DocumentView[] = {
    "DocumentView\0"
};

const QMetaObject DocumentView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_DocumentView,
      qt_meta_data_DocumentView, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DocumentView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DocumentView))
