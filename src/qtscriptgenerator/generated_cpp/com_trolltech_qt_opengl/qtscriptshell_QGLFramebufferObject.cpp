...
QtScriptShell_QGLFramebufferObject::QtScriptShell_QGLFramebufferObject(const QSize&  size, QGLFramebufferObject::Attachment  attachment, unsigned int  target, unsigned int  internal_format)
    : QGLFramebufferObject(size, attachment, target, internal_format) {}
...
QtScriptShell_QGLFramebufferObject::QtScriptShell_QGLFramebufferObject(const QSize&  size, unsigned int  target)
    : QGLFramebufferObject(size, target) {}

QtScriptShell_QGLFramebufferObject::QtScriptShell_QGLFramebufferObject(int  width, int  height, QGLFramebufferObject::Attachment  attachment, unsigned int  target, unsigned int  internal_format)
    : QGLFramebufferObject(width, height, attachment, target, internal_format) {}
...
QtScriptShell_QGLFramebufferObject::QtScriptShell_QGLFramebufferObject(int  width, int  height, unsigned int  target)
    : QGLFramebufferObject(width, height, target) {}
