...
Q_DECLARE_METATYPE(QFlags<Qt::ApplicationState>)
Q_DECLARE_METATYPE(Qt::DockWidgetAreaSizes)
Q_DECLARE_METATYPE(Qt::AnchorPoint)
Q_DECLARE_METATYPE(Qt::FindChildOption)
Q_DECLARE_METATYPE(QFlags<Qt::FindChildOption>)
...
{
    if ((value >= Qt::CaseInsensitive) && (value <= Qt::CaseSensitive))
        return qtscript_Qt_CaseSensitivity_keys[static_cast<int>(value)-static_cast<int>(Qt::CaseInsensitive)];
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_CaseSensitivity(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= Qt::CaseInsensitive) && (arg <= Qt::CaseSensitive))
...
{
    if ((value >= Qt::ElideLeft) && (value <= Qt::ElideNone))
        return qtscript_Qt_TextElideMode_keys[static_cast<int>(value)-static_cast<int>(Qt::ElideLeft)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::ElideLeft) && (arg <= Qt::ElideNone))
...
{
    for (int i = 0; i < 4; ++i) {
        if (qtscript_Qt_PenCapStyle_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_PenCapStyle_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_PenCapStyle(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 4; ++i) {
        if (qtscript_Qt_PenCapStyle_values[i] == arg)
...
{
    if ((value >= Qt::OddEvenFill) && (value <= Qt::WindingFill))
        return qtscript_Qt_FillRule_keys[static_cast<int>(value)-static_cast<int>(Qt::OddEvenFill)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::OddEvenFill) && (arg <= Qt::WindingFill))
...
{
    for (int i = 0; i < 14; ++i) {
        if (qtscript_Qt_ApplicationAttribute_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_ApplicationAttribute_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_ApplicationAttribute(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 14; ++i) {
        if (qtscript_Qt_ApplicationAttribute_values[i] == arg)
...
{
    if ((value >= Qt::LocalTime) && (value <= Qt::OffsetFromUTC))
        return qtscript_Qt_TimeSpec_keys[static_cast<int>(value)-static_cast<int>(Qt::LocalTime)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::LocalTime) && (arg <= Qt::OffsetFromUTC))
...
{
    if ((value >= Qt::ScrollBarAsNeeded) && (value <= Qt::ScrollBarAlwaysOn))
        return qtscript_Qt_ScrollBarPolicy_keys[static_cast<int>(value)-static_cast<int>(Qt::ScrollBarAsNeeded)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::ScrollBarAsNeeded) && (arg <= Qt::ScrollBarAlwaysOn))
...
{
    for (int i = 0; i < 5; ++i) {
        if (qtscript_Qt_ConnectionType_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_ConnectionType_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_ConnectionType(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 5; ++i) {
        if (qtscript_Qt_ConnectionType_values[i] == arg)
...
{
    for (int i = 0; i < 24; ++i) {
        if (qtscript_Qt_CursorShape_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_CursorShape_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_CursorShape(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 24; ++i) {
        if (qtscript_Qt_CursorShape_values[i] == arg)
...
{
    if ((value >= Qt::TextDate) && (value <= Qt::DefaultLocaleLongDate))
        return qtscript_Qt_DateFormat_keys[static_cast<int>(value)-static_cast<int>(Qt::TextDate)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::TextDate) && (arg <= Qt::DefaultLocaleLongDate))
...
static const Qt::CursorMoveStyle qtscript_Qt_CursorMoveStyle_values[] = {
    Qt::LogicalMoveStyle
    , Qt::VisualMoveStyle
};

static const char * const qtscript_Qt_CursorMoveStyle_keys[] = {
    "LogicalMoveStyle"
    , "VisualMoveStyle"
};

static QString qtscript_Qt_CursorMoveStyle_toStringHelper(Qt::CursorMoveStyle value)
{
    if ((value >= Qt::LogicalMoveStyle) && (value <= Qt::VisualMoveStyle))
        return qtscript_Qt_CursorMoveStyle_keys[static_cast<int>(value)-static_cast<int>(Qt::LogicalMoveStyle)];
    return QString();
}

static QScriptValue qtscript_Qt_CursorMoveStyle_toScriptValue(QScriptEngine *engine, const Qt::CursorMoveStyle &value)
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Qt"));
    return clazz.property(qtscript_Qt_CursorMoveStyle_toStringHelper(value));
}

static void qtscript_Qt_CursorMoveStyle_fromScriptValue(const QScriptValue &value, Qt::CursorMoveStyle &out)
{
    out = qvariant_cast<Qt::CursorMoveStyle>(value.toVariant());
}

static QScriptValue qtscript_construct_Qt_CursorMoveStyle(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::LogicalMoveStyle) && (arg <= Qt::VisualMoveStyle))
        return qScriptValueFromValue(engine,  static_cast<Qt::CursorMoveStyle>(arg));
    return context->throwError(QString::fromLatin1("CursorMoveStyle(): invalid enum value (%0)").arg(arg));
}

static QScriptValue qtscript_Qt_CursorMoveStyle_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::CursorMoveStyle value = qscriptvalue_cast<Qt::CursorMoveStyle>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_CursorMoveStyle_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::CursorMoveStyle value = qscriptvalue_cast<Qt::CursorMoveStyle>(context->thisObject());
    return QScriptValue(engine, qtscript_Qt_CursorMoveStyle_toStringHelper(value));
}

static QScriptValue qtscript_create_Qt_CursorMoveStyle_class(QScriptEngine *engine, QScriptValue &clazz)
{
    QScriptValue ctor = qtscript_create_enum_class_helper(
        engine, qtscript_construct_Qt_CursorMoveStyle,
        qtscript_Qt_CursorMoveStyle_valueOf, qtscript_Qt_CursorMoveStyle_toString);
    qScriptRegisterMetaType<Qt::CursorMoveStyle>(engine, qtscript_Qt_CursorMoveStyle_toScriptValue,
...
{
    for (int i = 0; i < 21; ++i) {
        if (qtscript_Qt_InputMethodHint_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_InputMethodHint_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_InputMethodHint(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 21; ++i) {
        if (qtscript_Qt_InputMethodHint_values[i] == arg)
...
static QString qtscript_Qt_SizeMode_toStringHelper(Qt::SizeMode value)
{
    if ((value >= Qt::AbsoluteSize) && (value <= Qt::RelativeSize))
        return qtscript_Qt_SizeMode_keys[static_cast<int>(value)-static_cast<int>(Qt::AbsoluteSize)];
    return QString();
}
...
{
    if ((value >= Qt::Monday) && (value <= Qt::Sunday))
        return qtscript_Qt_DayOfWeek_keys[static_cast<int>(value)-static_cast<int>(Qt::Monday)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::Monday) && (arg <= Qt::Sunday))
...
{
    for (int i = 0; i < 19; ++i) {
        if (qtscript_Qt_BrushStyle_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_BrushStyle_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_BrushStyle(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 19; ++i) {
        if (qtscript_Qt_BrushStyle_values[i] == arg)
...
static QString qtscript_Qt_SortOrder_toStringHelper(Qt::SortOrder value)
{
    if ((value >= Qt::AscendingOrder) && (value <= Qt::DescendingOrder))
        return qtscript_Qt_SortOrder_keys[static_cast<int>(value)-static_cast<int>(Qt::AscendingOrder)];
    return QString();
}
...
{
    for (int i = 0; i < 5; ++i) {
        if (qtscript_Qt_FocusPolicy_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_FocusPolicy_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_FocusPolicy(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 5; ++i) {
        if (qtscript_Qt_FocusPolicy_values[i] == arg)
...
static QString qtscript_Qt_MaskMode_toStringHelper(Qt::MaskMode value)
{
    if ((value >= Qt::MaskInColor) && (value <= Qt::MaskOutColor))
        return qtscript_Qt_MaskMode_keys[static_cast<int>(value)-static_cast<int>(Qt::MaskInColor)];
    return QString();
}
...
static QString qtscript_Qt_GestureState_toStringHelper(Qt::GestureState value)
{
    if ((value >= Qt::NoGesture) && (value <= Qt::GestureCanceled))
        return qtscript_Qt_GestureState_keys[static_cast<int>(value)-static_cast<int>(Qt::NoGesture)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::NoGesture) && (arg <= Qt::GestureCanceled))
...
{
    if ((value >= Qt::ContainsItemShape) && (value <= Qt::IntersectsItemBoundingRect))
        return qtscript_Qt_ItemSelectionMode_keys[static_cast<int>(value)-static_cast<int>(Qt::ContainsItemShape)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::ContainsItemShape) && (arg <= Qt::IntersectsItemBoundingRect))
...
{
    if ((value >= Qt::ToolButtonIconOnly) && (value <= Qt::ToolButtonFollowStyle))
        return qtscript_Qt_ToolButtonStyle_keys[static_cast<int>(value)-static_cast<int>(Qt::ToolButtonIconOnly)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::ToolButtonIconOnly) && (arg <= Qt::ToolButtonFollowStyle))
...
static QString qtscript_Qt_Corner_toStringHelper(Qt::Corner value)
{
    if ((value >= Qt::TopLeftCorner) && (value <= Qt::BottomRightCorner))
        return qtscript_Qt_Corner_keys[static_cast<int>(value)-static_cast<int>(Qt::TopLeftCorner)];
    return QString();
}
...
{
    for (int i = 0; i < 8; ++i) {
        if (qtscript_Qt_TextInteractionFlag_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_TextInteractionFlag_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_TextInteractionFlag(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 8; ++i) {
        if (qtscript_Qt_TextInteractionFlag_values[i] == arg)
...
{
    if ((value >= Qt::LeftToRight) && (value <= Qt::LayoutDirectionAuto))
        return qtscript_Qt_LayoutDirection_keys[static_cast<int>(value)-static_cast<int>(Qt::LeftToRight)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::LeftToRight) && (arg <= Qt::LayoutDirectionAuto))
...
{
    if ((value >= Qt::PlainText) && (value <= Qt::AutoText))
        return qtscript_Qt_TextFormat_keys[static_cast<int>(value)-static_cast<int>(Qt::PlainText)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::PlainText) && (arg <= Qt::AutoText))
...
{
    if ((value >= Qt::NoClip) && (value <= Qt::IntersectClip))
        return qtscript_Qt_ClipOperation_keys[static_cast<int>(value)-static_cast<int>(Qt::NoClip)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::NoClip) && (arg <= Qt::IntersectClip))
...
{
    for (int i = 0; i < 6; ++i) {
        if (qtscript_Qt_DockWidgetArea_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_DockWidgetArea_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_DockWidgetArea(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 6; ++i) {
        if (qtscript_Qt_DockWidgetArea_values[i] == arg)
...
{
    if ((value >= Qt::NoArrow) && (value <= Qt::RightArrow))
        return qtscript_Qt_ArrowType_keys[static_cast<int>(value)-static_cast<int>(Qt::NoArrow)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::NoArrow) && (arg <= Qt::RightArrow))
...
static QString qtscript_Qt_Axis_toStringHelper(Qt::Axis value)
{
    if ((value >= Qt::XAxis) && (value <= Qt::ZAxis))
        return qtscript_Qt_Axis_keys[static_cast<int>(value)-static_cast<int>(Qt::XAxis)];
    return QString();
}
...
static const Qt::TimerType qtscript_Qt_TimerType_values[] = {
    Qt::PreciseTimer
    , Qt::CoarseTimer
    , Qt::VeryCoarseTimer
};

static const char * const qtscript_Qt_TimerType_keys[] = {
    "PreciseTimer"
    , "CoarseTimer"
    , "VeryCoarseTimer"
};

static QString qtscript_Qt_TimerType_toStringHelper(Qt::TimerType value)
{
    if ((value >= Qt::PreciseTimer) && (value <= Qt::VeryCoarseTimer))
        return qtscript_Qt_TimerType_keys[static_cast<int>(value)-static_cast<int>(Qt::PreciseTimer)];
    return QString();
}

static QScriptValue qtscript_Qt_TimerType_toScriptValue(QScriptEngine *engine, const Qt::TimerType &value)
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Qt"));
    return clazz.property(qtscript_Qt_TimerType_toStringHelper(value));
}

static void qtscript_Qt_TimerType_fromScriptValue(const QScriptValue &value, Qt::TimerType &out)
{
    out = qvariant_cast<Qt::TimerType>(value.toVariant());
}

static QScriptValue qtscript_construct_Qt_TimerType(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::PreciseTimer) && (arg <= Qt::VeryCoarseTimer))
        return qScriptValueFromValue(engine,  static_cast<Qt::TimerType>(arg));
    return context->throwError(QString::fromLatin1("TimerType(): invalid enum value (%0)").arg(arg));
}

static QScriptValue qtscript_Qt_TimerType_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::TimerType value = qscriptvalue_cast<Qt::TimerType>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_TimerType_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::TimerType value = qscriptvalue_cast<Qt::TimerType>(context->thisObject());
    return QScriptValue(engine, qtscript_Qt_TimerType_toStringHelper(value));
}

static QScriptValue qtscript_create_Qt_TimerType_class(QScriptEngine *engine, QScriptValue &clazz)
{
    QScriptValue ctor = qtscript_create_enum_class_helper(
        engine, qtscript_construct_Qt_TimerType,
        qtscript_Qt_TimerType_valueOf, qtscript_Qt_TimerType_toString);
    qScriptRegisterMetaType<Qt::TimerType>(engine, qtscript_Qt_TimerType_toScriptValue,
...
{
    for (int i = 0; i < 8; ++i) {
        if (qtscript_Qt_PenStyle_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_PenStyle_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_PenStyle(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 8; ++i) {
        if (qtscript_Qt_PenStyle_values[i] == arg)
...
static QString qtscript_Qt_TransformationMode_toStringHelper(Qt::TransformationMode value)
{
    if ((value >= Qt::FastTransformation) && (value <= Qt::SmoothTransformation))
        return qtscript_Qt_TransformationMode_keys[static_cast<int>(value)-static_cast<int>(Qt::FastTransformation)];
    return QString();
}
...
static const Qt::ScreenOrientation qtscript_Qt_ScreenOrientation_values[] = {
...
static const char * const qtscript_Qt_ScreenOrientation_keys[] = {
    "PrimaryOrientation"
    , "PortraitOrientation"
...
static QString qtscript_Qt_ScreenOrientation_toStringHelper(Qt::ScreenOrientation value)
{
    for (int i = 0; i < 5; ++i) {
        if (qtscript_Qt_ScreenOrientation_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_ScreenOrientation_keys[i]);
    }
    return QString();
}

static QScriptValue qtscript_Qt_ScreenOrientation_toScriptValue(QScriptEngine *engine, const Qt::ScreenOrientation &value)
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Qt"));
    return clazz.property(qtscript_Qt_ScreenOrientation_toStringHelper(value));
}

static void qtscript_Qt_ScreenOrientation_fromScriptValue(const QScriptValue &value, Qt::ScreenOrientation &out)
{
    out = qvariant_cast<Qt::ScreenOrientation>(value.toVariant());
}

static QScriptValue qtscript_construct_Qt_ScreenOrientation(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 5; ++i) {
        if (qtscript_Qt_ScreenOrientation_values[i] == arg)
            return qScriptValueFromValue(engine,  static_cast<Qt::ScreenOrientation>(arg));
    }
    return context->throwError(QString::fromLatin1("ScreenOrientation(): invalid enum value (%0)").arg(arg));
}

static QScriptValue qtscript_Qt_ScreenOrientation_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ScreenOrientation value = qscriptvalue_cast<Qt::ScreenOrientation>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_ScreenOrientation_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ScreenOrientation value = qscriptvalue_cast<Qt::ScreenOrientation>(context->thisObject());
    return QScriptValue(engine, qtscript_Qt_ScreenOrientation_toStringHelper(value));
}

static QScriptValue qtscript_create_Qt_ScreenOrientation_class(QScriptEngine *engine, QScriptValue &clazz)
{
    QScriptValue ctor = qtscript_create_enum_class_helper(
        engine, qtscript_construct_Qt_ScreenOrientation,
        qtscript_Qt_ScreenOrientation_valueOf, qtscript_Qt_ScreenOrientation_toString);
    qScriptRegisterMetaType<Qt::ScreenOrientation>(engine, qtscript_Qt_ScreenOrientation_toScriptValue,
...
static QScriptValue qtscript_Qt_ScreenOrientations_toScriptValue(QScriptEngine *engine, const Qt::ScreenOrientations &value)
{
    return engine->newVariant(qVariantFromValue(value));
}

static void qtscript_Qt_ScreenOrientations_fromScriptValue(const QScriptValue &value, Qt::ScreenOrientations &out)
{
    QVariant var = value.toVariant();
    if (var.userType() == qMetaTypeId<Qt::ScreenOrientations>())
        out = qvariant_cast<Qt::ScreenOrientations>(var);
    else if (var.userType() == qMetaTypeId<Qt::ScreenOrientation>())
        out = qvariant_cast<Qt::ScreenOrientation>(var);
    else
        out = 0;
}

static QScriptValue qtscript_construct_Qt_ScreenOrientations(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ScreenOrientations result = 0;
    if ((context->argumentCount() == 1) && context->argument(0).isNumber()) {
        result = static_cast<Qt::ScreenOrientations>(context->argument(0).toInt32());
    } else {
        for (int i = 0; i < context->argumentCount(); ++i) {
            QVariant v = context->argument(i).toVariant();
            if (v.userType() != qMetaTypeId<Qt::ScreenOrientation>()) {
                return context->throwError(QScriptContext::TypeError,
                    QString::fromLatin1("ScreenOrientations(): argument %0 is not of type ScreenOrientation").arg(i));
            }
            result |= qvariant_cast<Qt::ScreenOrientation>(v);
        }
   }
    return engine->newVariant(qVariantFromValue(result));
}

static QScriptValue qtscript_Qt_ScreenOrientations_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ScreenOrientations value = qscriptvalue_cast<Qt::ScreenOrientations>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_ScreenOrientations_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ScreenOrientations value = qscriptvalue_cast<Qt::ScreenOrientations>(context->thisObject());
    QString result;
    for (int i = 0; i < 5; ++i) {
        if ((value & qtscript_Qt_ScreenOrientation_values[i]) == qtscript_Qt_ScreenOrientation_values[i]) {
            if (!result.isEmpty())
                result.append(QString::fromLatin1(","));
            result.append(QString::fromLatin1(qtscript_Qt_ScreenOrientation_keys[i]));
        }
    }
    return QScriptValue(engine, result);
}

static QScriptValue qtscript_Qt_ScreenOrientations_equals(QScriptContext *context, QScriptEngine *engine)
{
    QVariant thisObj = context->thisObject().toVariant();
    QVariant otherObj = context->argument(0).toVariant();
    return QScriptValue(engine, ((thisObj.userType() == otherObj.userType()) &&
                                 (thisObj.value<Qt::ScreenOrientations>() == otherObj.value<Qt::ScreenOrientations>())));
}

static QScriptValue qtscript_create_Qt_ScreenOrientations_class(QScriptEngine *engine)
{
    QScriptValue ctor = qtscript_create_flags_class_helper(
        engine, qtscript_construct_Qt_ScreenOrientations, qtscript_Qt_ScreenOrientations_valueOf,
        qtscript_Qt_ScreenOrientations_toString, qtscript_Qt_ScreenOrientations_equals);
    qScriptRegisterMetaType<Qt::ScreenOrientations>(engine, qtscript_Qt_ScreenOrientations_toScriptValue,
        qtscript_Qt_ScreenOrientations_fromScriptValue, ctor.property(QString::fromLatin1("prototype")));
    return ctor;
}
...
static QString qtscript_Qt_SizeHint_toStringHelper(Qt::SizeHint value)
{
    if ((value >= Qt::MinimumSize) && (value <= Qt::NSizeHints))
        return qtscript_Qt_SizeHint_keys[static_cast<int>(value)-static_cast<int>(Qt::MinimumSize)];
    return QString();
}
...
{
    for (int i = 0; i < 7; ++i) {
        if (qtscript_Qt_GestureType_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_GestureType_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_GestureType(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 7; ++i) {
        if (qtscript_Qt_GestureType_values[i] == arg)
...
{
    if ((value >= Qt::NonModal) && (value <= Qt::ApplicationModal))
        return qtscript_Qt_WindowModality_keys[static_cast<int>(value)-static_cast<int>(Qt::NonModal)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::NonModal) && (arg <= Qt::ApplicationModal))
...
{
    for (int i = 0; i < 13; ++i) {
        if (qtscript_Qt_InputMethodQuery_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_InputMethodQuery_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_InputMethodQuery(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 13; ++i) {
        if (qtscript_Qt_InputMethodQuery_values[i] == arg)
...
static QScriptValue qtscript_Qt_InputMethodQueries_toScriptValue(QScriptEngine *engine, const Qt::InputMethodQueries &value)
{
    return engine->newVariant(qVariantFromValue(value));
}

static void qtscript_Qt_InputMethodQueries_fromScriptValue(const QScriptValue &value, Qt::InputMethodQueries &out)
{
    QVariant var = value.toVariant();
    if (var.userType() == qMetaTypeId<Qt::InputMethodQueries>())
        out = qvariant_cast<Qt::InputMethodQueries>(var);
    else if (var.userType() == qMetaTypeId<Qt::InputMethodQuery>())
        out = qvariant_cast<Qt::InputMethodQuery>(var);
    else
        out = 0;
}

static QScriptValue qtscript_construct_Qt_InputMethodQueries(QScriptContext *context, QScriptEngine *engine)
{
    Qt::InputMethodQueries result = 0;
    if ((context->argumentCount() == 1) && context->argument(0).isNumber()) {
        result = static_cast<Qt::InputMethodQueries>(context->argument(0).toInt32());
    } else {
        for (int i = 0; i < context->argumentCount(); ++i) {
            QVariant v = context->argument(i).toVariant();
            if (v.userType() != qMetaTypeId<Qt::InputMethodQuery>()) {
                return context->throwError(QScriptContext::TypeError,
                    QString::fromLatin1("InputMethodQueries(): argument %0 is not of type InputMethodQuery").arg(i));
            }
            result |= qvariant_cast<Qt::InputMethodQuery>(v);
        }
   }
    return engine->newVariant(qVariantFromValue(result));
}

static QScriptValue qtscript_Qt_InputMethodQueries_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::InputMethodQueries value = qscriptvalue_cast<Qt::InputMethodQueries>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_InputMethodQueries_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::InputMethodQueries value = qscriptvalue_cast<Qt::InputMethodQueries>(context->thisObject());
    QString result;
    for (int i = 0; i < 13; ++i) {
        if ((value & qtscript_Qt_InputMethodQuery_values[i]) == qtscript_Qt_InputMethodQuery_values[i]) {
            if (!result.isEmpty())
                result.append(QString::fromLatin1(","));
            result.append(QString::fromLatin1(qtscript_Qt_InputMethodQuery_keys[i]));
        }
    }
    return QScriptValue(engine, result);
}

static QScriptValue qtscript_Qt_InputMethodQueries_equals(QScriptContext *context, QScriptEngine *engine)
{
    QVariant thisObj = context->thisObject().toVariant();
    QVariant otherObj = context->argument(0).toVariant();
    return QScriptValue(engine, ((thisObj.userType() == otherObj.userType()) &&
                                 (thisObj.value<Qt::InputMethodQueries>() == otherObj.value<Qt::InputMethodQueries>())));
}

static QScriptValue qtscript_create_Qt_InputMethodQueries_class(QScriptEngine *engine)
{
    QScriptValue ctor = qtscript_create_flags_class_helper(
        engine, qtscript_construct_Qt_InputMethodQueries, qtscript_Qt_InputMethodQueries_valueOf,
        qtscript_Qt_InputMethodQueries_toString, qtscript_Qt_InputMethodQueries_equals);
    qScriptRegisterMetaType<Qt::InputMethodQueries>(engine, qtscript_Qt_InputMethodQueries_toScriptValue,
        qtscript_Qt_InputMethodQueries_fromScriptValue, ctor.property(QString::fromLatin1("prototype")));
    return ctor;
}
...
{
    for (int i = 0; i < 5; ++i) {
        if (qtscript_Qt_PenJoinStyle_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_PenJoinStyle_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_PenJoinStyle(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 5; ++i) {
        if (qtscript_Qt_PenJoinStyle_values[i] == arg)
...
static QString qtscript_Qt_CheckState_toStringHelper(Qt::CheckState value)
{
    if ((value >= Qt::Unchecked) && (value <= Qt::Checked))
        return qtscript_Qt_CheckState_keys[static_cast<int>(value)-static_cast<int>(Qt::Unchecked)];
    return QString();
}
...
{
    if ((value >= Qt::WidgetShortcut) && (value <= Qt::WidgetWithChildrenShortcut))
        return qtscript_Qt_ShortcutContext_keys[static_cast<int>(value)-static_cast<int>(Qt::WidgetShortcut)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::WidgetShortcut) && (arg <= Qt::WidgetWithChildrenShortcut))
...
static const Qt::Edge qtscript_Qt_Edge_values[] = {
    Qt::TopEdge
    , Qt::LeftEdge
    , Qt::RightEdge
    , Qt::BottomEdge
...
static const char * const qtscript_Qt_Edge_keys[] = {
    "TopEdge"
    , "LeftEdge"
    , "RightEdge"
    , "BottomEdge"
...
static QString qtscript_Qt_Edge_toStringHelper(Qt::Edge value)
{
    for (int i = 0; i < 4; ++i) {
        if (qtscript_Qt_Edge_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_Edge_keys[i]);
    }
    return QString();
}

static QScriptValue qtscript_Qt_Edge_toScriptValue(QScriptEngine *engine, const Qt::Edge &value)
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Qt"));
    return clazz.property(qtscript_Qt_Edge_toStringHelper(value));
}

static void qtscript_Qt_Edge_fromScriptValue(const QScriptValue &value, Qt::Edge &out)
{
    out = qvariant_cast<Qt::Edge>(value.toVariant());
}

static QScriptValue qtscript_construct_Qt_Edge(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 4; ++i) {
        if (qtscript_Qt_Edge_values[i] == arg)
            return qScriptValueFromValue(engine,  static_cast<Qt::Edge>(arg));
    }
    return context->throwError(QString::fromLatin1("Edge(): invalid enum value (%0)").arg(arg));
}

static QScriptValue qtscript_Qt_Edge_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::Edge value = qscriptvalue_cast<Qt::Edge>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_Edge_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::Edge value = qscriptvalue_cast<Qt::Edge>(context->thisObject());
    return QScriptValue(engine, qtscript_Qt_Edge_toStringHelper(value));
}

static QScriptValue qtscript_create_Qt_Edge_class(QScriptEngine *engine, QScriptValue &clazz)
{
    QScriptValue ctor = qtscript_create_enum_class_helper(
        engine, qtscript_construct_Qt_Edge,
        qtscript_Qt_Edge_valueOf, qtscript_Qt_Edge_toString);
    qScriptRegisterMetaType<Qt::Edge>(engine, qtscript_Qt_Edge_toScriptValue,
        qtscript_Qt_Edge_fromScriptValue, ctor.property(QString::fromLatin1("prototype")));
    for (int i = 0; i < 4; ++i) {
        clazz.setProperty(QString::fromLatin1(qtscript_Qt_Edge_keys[i]),
            engine->newVariant(qVariantFromValue(qtscript_Qt_Edge_values[i])),
            QScriptValue::ReadOnly | QScriptValue::Undeletable);
    }
    return ctor;
}
...
{
    if ((value >= Qt::TransparentMode) && (value <= Qt::OpaqueMode))
        return qtscript_Qt_BGMode_keys[static_cast<int>(value)-static_cast<int>(Qt::TransparentMode)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::TransparentMode) && (arg <= Qt::OpaqueMode))
...
{
    if ((value >= Qt::IgnoreAspectRatio) && (value <= Qt::KeepAspectRatioByExpanding))
        return qtscript_Qt_AspectRatioMode_keys[static_cast<int>(value)-static_cast<int>(Qt::IgnoreAspectRatio)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::IgnoreAspectRatio) && (arg <= Qt::KeepAspectRatioByExpanding))
...
{
    if ((value >= Qt::Horizontal) && (value <= Qt::Vertical))
        return qtscript_Qt_Orientation_keys[static_cast<int>(value)-static_cast<int>(Qt::Horizontal)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::Horizontal) && (arg <= Qt::Vertical))
...
{
    if ((value >= Qt::color0) && (value <= Qt::transparent))
        return qtscript_Qt_GlobalColor_keys[static_cast<int>(value)-static_cast<int>(Qt::color0)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::color0) && (arg <= Qt::transparent))
...
{
    for (int i = 0; i < 421; ++i) {
        if (qtscript_Qt_Key_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_Key_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_Key(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 421; ++i) {
        if (qtscript_Qt_Key_values[i] == arg)
...
{
    for (int i = 0; i < 6; ++i) {
        if (qtscript_Qt_ToolBarArea_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_ToolBarArea_keys[i]);
    }
    return QString();
}
...
static QScriptValue qtscript_construct_Qt_ToolBarArea(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 6; ++i) {
        if (qtscript_Qt_ToolBarArea_values[i] == arg)
...
{
    if ((value >= Qt::NoContextMenu) && (value <= Qt::PreventContextMenu))
        return qtscript_Qt_ContextMenuPolicy_keys[static_cast<int>(value)-static_cast<int>(Qt::NoContextMenu)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::NoContextMenu) && (arg <= Qt::PreventContextMenu))
...
static const Qt::ApplicationState qtscript_Qt_ApplicationState_values[] = {
...
static const char * const qtscript_Qt_ApplicationState_keys[] = {
...
static QString qtscript_Qt_ApplicationState_toStringHelper(Qt::ApplicationState value)
{
    for (int i = 0; i < 4; ++i) {
        if (qtscript_Qt_ApplicationState_values[i] == value)
            return QString::fromLatin1(qtscript_Qt_ApplicationState_keys[i]);
    }
    return QString();
}

static QScriptValue qtscript_Qt_ApplicationState_toScriptValue(QScriptEngine *engine, const Qt::ApplicationState &value)
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Qt"));
    return clazz.property(qtscript_Qt_ApplicationState_toStringHelper(value));
}

static void qtscript_Qt_ApplicationState_fromScriptValue(const QScriptValue &value, Qt::ApplicationState &out)
{
    out = qvariant_cast<Qt::ApplicationState>(value.toVariant());
}

static QScriptValue qtscript_construct_Qt_ApplicationState(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    for (int i = 0; i < 4; ++i) {
        if (qtscript_Qt_ApplicationState_values[i] == arg)
            return qScriptValueFromValue(engine,  static_cast<Qt::ApplicationState>(arg));
    }
    return context->throwError(QString::fromLatin1("ApplicationState(): invalid enum value (%0)").arg(arg));
}

static QScriptValue qtscript_Qt_ApplicationState_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ApplicationState value = qscriptvalue_cast<Qt::ApplicationState>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_ApplicationState_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ApplicationState value = qscriptvalue_cast<Qt::ApplicationState>(context->thisObject());
    return QScriptValue(engine, qtscript_Qt_ApplicationState_toStringHelper(value));
}

static QScriptValue qtscript_create_Qt_ApplicationState_class(QScriptEngine *engine, QScriptValue &clazz)
{
    QScriptValue ctor = qtscript_create_enum_class_helper(
        engine, qtscript_construct_Qt_ApplicationState,
        qtscript_Qt_ApplicationState_valueOf, qtscript_Qt_ApplicationState_toString);
    qScriptRegisterMetaType<Qt::ApplicationState>(engine, qtscript_Qt_ApplicationState_toScriptValue,
        qtscript_Qt_ApplicationState_fromScriptValue, ctor.property(QString::fromLatin1("prototype")));
    for (int i = 0; i < 4; ++i) {
        clazz.setProperty(QString::fromLatin1(qtscript_Qt_ApplicationState_keys[i]),
            engine->newVariant(qVariantFromValue(qtscript_Qt_ApplicationState_values[i])),
            QScriptValue::ReadOnly | QScriptValue::Undeletable);
    }
    return ctor;
}
...
static QScriptValue qtscript_Qt_ApplicationStates_toScriptValue(QScriptEngine *engine, const Qt::ApplicationStates &value)
{
    return engine->newVariant(qVariantFromValue(value));
}

static void qtscript_Qt_ApplicationStates_fromScriptValue(const QScriptValue &value, Qt::ApplicationStates &out)
{
    QVariant var = value.toVariant();
    if (var.userType() == qMetaTypeId<Qt::ApplicationStates>())
        out = qvariant_cast<Qt::ApplicationStates>(var);
    else if (var.userType() == qMetaTypeId<Qt::ApplicationState>())
        out = qvariant_cast<Qt::ApplicationState>(var);
    else
        out = 0;
}

static QScriptValue qtscript_construct_Qt_ApplicationStates(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ApplicationStates result = 0;
    if ((context->argumentCount() == 1) && context->argument(0).isNumber()) {
        result = static_cast<Qt::ApplicationStates>(context->argument(0).toInt32());
    } else {
        for (int i = 0; i < context->argumentCount(); ++i) {
            QVariant v = context->argument(i).toVariant();
            if (v.userType() != qMetaTypeId<Qt::ApplicationState>()) {
                return context->throwError(QScriptContext::TypeError,
                    QString::fromLatin1("ApplicationStates(): argument %0 is not of type ApplicationState").arg(i));
            }
            result |= qvariant_cast<Qt::ApplicationState>(v);
        }
   }
    return engine->newVariant(qVariantFromValue(result));
}

static QScriptValue qtscript_Qt_ApplicationStates_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ApplicationStates value = qscriptvalue_cast<Qt::ApplicationStates>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_ApplicationStates_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::ApplicationStates value = qscriptvalue_cast<Qt::ApplicationStates>(context->thisObject());
    QString result;
    for (int i = 0; i < 4; ++i) {
        if ((value & qtscript_Qt_ApplicationState_values[i]) == qtscript_Qt_ApplicationState_values[i]) {
            if (!result.isEmpty())
                result.append(QString::fromLatin1(","));
            result.append(QString::fromLatin1(qtscript_Qt_ApplicationState_keys[i]));
        }
    }
    return QScriptValue(engine, result);
}

static QScriptValue qtscript_Qt_ApplicationStates_equals(QScriptContext *context, QScriptEngine *engine)
{
    QVariant thisObj = context->thisObject().toVariant();
    QVariant otherObj = context->argument(0).toVariant();
    return QScriptValue(engine, ((thisObj.userType() == otherObj.userType()) &&
                                 (thisObj.value<Qt::ApplicationStates>() == otherObj.value<Qt::ApplicationStates>())));
}

static QScriptValue qtscript_create_Qt_ApplicationStates_class(QScriptEngine *engine)
{
    QScriptValue ctor = qtscript_create_flags_class_helper(
        engine, qtscript_construct_Qt_ApplicationStates, qtscript_Qt_ApplicationStates_valueOf,
        qtscript_Qt_ApplicationStates_toString, qtscript_Qt_ApplicationStates_equals);
    qScriptRegisterMetaType<Qt::ApplicationStates>(engine, qtscript_Qt_ApplicationStates_toScriptValue,
        qtscript_Qt_ApplicationStates_fromScriptValue, ctor.property(QString::fromLatin1("prototype")));
    return ctor;
}
...
static const Qt::FindChildOption qtscript_Qt_FindChildOption_values[] = {
    Qt::FindDirectChildrenOnly
    , Qt::FindChildrenRecursively
};

static const char * const qtscript_Qt_FindChildOption_keys[] = {
    "FindDirectChildrenOnly"
    , "FindChildrenRecursively"
};

static QString qtscript_Qt_FindChildOption_toStringHelper(Qt::FindChildOption value)
{
    if ((value >= Qt::FindDirectChildrenOnly) && (value <= Qt::FindChildrenRecursively))
        return qtscript_Qt_FindChildOption_keys[static_cast<int>(value)-static_cast<int>(Qt::FindDirectChildrenOnly)];
    return QString();
}

static QScriptValue qtscript_Qt_FindChildOption_toScriptValue(QScriptEngine *engine, const Qt::FindChildOption &value)
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Qt"));
    return clazz.property(qtscript_Qt_FindChildOption_toStringHelper(value));
}

static void qtscript_Qt_FindChildOption_fromScriptValue(const QScriptValue &value, Qt::FindChildOption &out)
{
    out = qvariant_cast<Qt::FindChildOption>(value.toVariant());
}

static QScriptValue qtscript_construct_Qt_FindChildOption(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    if ((arg >= Qt::FindDirectChildrenOnly) && (arg <= Qt::FindChildrenRecursively))
        return qScriptValueFromValue(engine,  static_cast<Qt::FindChildOption>(arg));
    return context->throwError(QString::fromLatin1("FindChildOption(): invalid enum value (%0)").arg(arg));
}

static QScriptValue qtscript_Qt_FindChildOption_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::FindChildOption value = qscriptvalue_cast<Qt::FindChildOption>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_FindChildOption_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::FindChildOption value = qscriptvalue_cast<Qt::FindChildOption>(context->thisObject());
    return QScriptValue(engine, qtscript_Qt_FindChildOption_toStringHelper(value));
}

static QScriptValue qtscript_create_Qt_FindChildOption_class(QScriptEngine *engine, QScriptValue &clazz)
{
    QScriptValue ctor = qtscript_create_enum_class_helper(
        engine, qtscript_construct_Qt_FindChildOption,
        qtscript_Qt_FindChildOption_valueOf, qtscript_Qt_FindChildOption_toString);
    qScriptRegisterMetaType<Qt::FindChildOption>(engine, qtscript_Qt_FindChildOption_toScriptValue,
...
static QScriptValue qtscript_Qt_FindChildOptions_toScriptValue(QScriptEngine *engine, const Qt::FindChildOptions &value)
{
    return engine->newVariant(qVariantFromValue(value));
}

static void qtscript_Qt_FindChildOptions_fromScriptValue(const QScriptValue &value, Qt::FindChildOptions &out)
{
    QVariant var = value.toVariant();
    if (var.userType() == qMetaTypeId<Qt::FindChildOptions>())
        out = qvariant_cast<Qt::FindChildOptions>(var);
    else if (var.userType() == qMetaTypeId<Qt::FindChildOption>())
        out = qvariant_cast<Qt::FindChildOption>(var);
    else
        out = 0;
}

static QScriptValue qtscript_construct_Qt_FindChildOptions(QScriptContext *context, QScriptEngine *engine)
{
    Qt::FindChildOptions result = 0;
    if ((context->argumentCount() == 1) && context->argument(0).isNumber()) {
        result = static_cast<Qt::FindChildOptions>(context->argument(0).toInt32());
    } else {
        for (int i = 0; i < context->argumentCount(); ++i) {
            QVariant v = context->argument(i).toVariant();
            if (v.userType() != qMetaTypeId<Qt::FindChildOption>()) {
                return context->throwError(QScriptContext::TypeError,
                    QString::fromLatin1("FindChildOptions(): argument %0 is not of type FindChildOption").arg(i));
            }
            result |= qvariant_cast<Qt::FindChildOption>(v);
        }
   }
    return engine->newVariant(qVariantFromValue(result));
}

static QScriptValue qtscript_Qt_FindChildOptions_valueOf(QScriptContext *context, QScriptEngine *engine)
{
    Qt::FindChildOptions value = qscriptvalue_cast<Qt::FindChildOptions>(context->thisObject());
    return QScriptValue(engine, static_cast<int>(value));
}

static QScriptValue qtscript_Qt_FindChildOptions_toString(QScriptContext *context, QScriptEngine *engine)
{
    Qt::FindChildOptions value = qscriptvalue_cast<Qt::FindChildOptions>(context->thisObject());
    QString result;
    for (int i = 0; i < 2; ++i) {
        if ((value & qtscript_Qt_FindChildOption_values[i]) == qtscript_Qt_FindChildOption_values[i]) {
            if (!result.isEmpty())
                result.append(QString::fromLatin1(","));
            result.append(QString::fromLatin1(qtscript_Qt_FindChildOption_keys[i]));
        }
    }
    return QScriptValue(engine, result);
}

static QScriptValue qtscript_Qt_FindChildOptions_equals(QScriptContext *context, QScriptEngine *engine)
{
    QVariant thisObj = context->thisObject().toVariant();
    QVariant otherObj = context->argument(0).toVariant();
    return QScriptValue(engine, ((thisObj.userType() == otherObj.userType()) &&
                                 (thisObj.value<Qt::FindChildOptions>() == otherObj.value<Qt::FindChildOptions>())));
}

static QScriptValue qtscript_create_Qt_FindChildOptions_class(QScriptEngine *engine)
{
    QScriptValue ctor = qtscript_create_flags_class_helper(
        engine, qtscript_construct_Qt_FindChildOptions, qtscript_Qt_FindChildOptions_valueOf,
        qtscript_Qt_FindChildOptions_toString, qtscript_Qt_FindChildOptions_equals);
    qScriptRegisterMetaType<Qt::FindChildOptions>(engine, qtscript_Qt_FindChildOptions_toScriptValue,
        qtscript_Qt_FindChildOptions_fromScriptValue, ctor.property(QString::fromLatin1("prototype")));
    return ctor;
}
...
QScriptValue qtscript_create_Qt_class(QScriptEngine *engine)
{
    ...
    ctor.setProperty(QString::fromLatin1("CursorMoveStyle"),
        qtscript_create_Qt_CursorMoveStyle_class(engine, ctor));
    ...
    ctor.setProperty(QString::fromLatin1("TimerType"),
        qtscript_create_Qt_TimerType_class(engine, ctor));
    ...
    ctor.setProperty(QString::fromLatin1("ScreenOrientation"),
        qtscript_create_Qt_ScreenOrientation_class(engine, ctor));
    ctor.setProperty(QString::fromLatin1("ScreenOrientations"),
        qtscript_create_Qt_ScreenOrientations_class(engine));
    ...
    ctor.setProperty(QString::fromLatin1("InputMethodQueries"),
        qtscript_create_Qt_InputMethodQueries_class(engine));
    ...
    ctor.setProperty(QString::fromLatin1("Edge"),
        qtscript_create_Qt_Edge_class(engine, ctor));
    ...
    ctor.setProperty(QString::fromLatin1("ApplicationState"),
        qtscript_create_Qt_ApplicationState_class(engine, ctor));
    ctor.setProperty(QString::fromLatin1("ApplicationStates"),
        qtscript_create_Qt_ApplicationStates_class(engine));
    ...
    ctor.setProperty(QString::fromLatin1("FindChildOption"),
        qtscript_create_Qt_FindChildOption_class(engine, ctor));
    ctor.setProperty(QString::fromLatin1("FindChildOptions"),
        qtscript_create_Qt_FindChildOptions_class(engine));
    return ctor;
}
