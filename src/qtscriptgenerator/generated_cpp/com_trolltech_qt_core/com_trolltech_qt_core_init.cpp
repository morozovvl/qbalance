...
QScriptValue qtscript_create_QElapsedTimer_class(QScriptEngine *engine);
...
QScriptValue qtscript_create_QUrlQuery_class(QScriptEngine *engine);
...
static const QtBindingCreator qtscript_com_trolltech_qt_core_class_functions[] = {
    ...
    , qtscript_create_QElapsedTimer_class
    ...
    , qtscript_create_QUrlQuery_class
