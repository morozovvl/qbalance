...
static QScriptValue qtscript_QSignalMapper_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QSignalMapper : public QSignalMapper
{

    friend QScriptValue qtscript_QSignalMapper_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QSignalMapper_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QSignalMapper* _q_self = reinterpret_cast<qtscript_QSignalMapper*>(qscriptvalue_cast<QSignalMapper*>(context->thisObject()));
    if (!_q_self) {
