...
static QScriptValue qtscript_QFile_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QFile : public QFile
{

    friend QScriptValue qtscript_QFile_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QFile_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QFile* _q_self = reinterpret_cast<qtscript_QFile*>(qscriptvalue_cast<QFile*>(context->thisObject()));
    if (!_q_self) {
