...
static QScriptValue qtscript_QCoreApplication_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QCoreApplication : public QCoreApplication
{

    friend QScriptValue qtscript_QCoreApplication_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QCoreApplication_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QCoreApplication* _q_self = reinterpret_cast<qtscript_QCoreApplication*>(qscriptvalue_cast<QCoreApplication*>(context->thisObject()));
    if (!_q_self) {
...
static QScriptValue qtscript_QCoreApplication_static_call(QScriptContext *context, QScriptEngine *)
{
    ...
    case 6:
    if (context->argumentCount() == 0) {
        QAbstractEventDispatcher* _q_result = QCoreApplication::eventDispatcher();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 22:
    if (context->argumentCount() == 1) {
        QAbstractEventDispatcher* _q_arg0 = qscriptvalue_cast<QAbstractEventDispatcher*>(context->argument(0));
        QCoreApplication::setEventDispatcher(_q_arg0);
        return context->engine()->undefinedValue();
    }
    break;
