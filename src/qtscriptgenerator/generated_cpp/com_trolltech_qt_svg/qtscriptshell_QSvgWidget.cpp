...
QtScriptShell_QSvgWidget::QtScriptShell_QSvgWidget(QWidget*  parent)
    : QSvgWidget(parent) {}

QtScriptShell_QSvgWidget::QtScriptShell_QSvgWidget(const QString&  file, QWidget*  parent)
    : QSvgWidget(file, parent) {}

QtScriptShell_QSvgWidget::~QtScriptShell_QSvgWidget() {}

void QtScriptShell_QSvgWidget::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QSvgWidget::devType() const
{
...
void QtScriptShell_QSvgWidget::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QSvgWidget::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QSvgWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QSvgWidget::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QSvgWidget::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QSvgWidget::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QSvgWidget::hasHeightForWidth() const
{
...
int  QtScriptShell_QSvgWidget::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QSvgWidget::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QSvgWidget::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QSvgWidget::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QSvgWidget::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QSvgWidget::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QSvgWidget::minimumSizeHint() const
{
...
void QtScriptShell_QSvgWidget::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QSvgWidget::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QSvgWidget::paintEngine() const
{
...
void QtScriptShell_QSvgWidget::paintEvent(QPaintEvent*  event)
{
...
QPaintDevice*  QtScriptShell_QSvgWidget::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QSvgWidget::resizeEvent(QResizeEvent*  arg__1)
{
...
QPainter*  QtScriptShell_QSvgWidget::sharedPainter() const
{
...
void QtScriptShell_QSvgWidget::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QSvgWidget::wheelEvent(QWheelEvent*  arg__1)
{
