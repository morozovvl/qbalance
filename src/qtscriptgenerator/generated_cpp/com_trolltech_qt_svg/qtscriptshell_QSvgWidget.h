...
class QtScriptShell_QSvgWidget : public QSvgWidget
{
public:
    QtScriptShell_QSvgWidget(QWidget*  parent = 0);
    QtScriptShell_QSvgWidget(const QString&  file, QWidget*  parent = 0);
...
#endif // QTSCRIPTSHELL_QSVGWIDGET_H
