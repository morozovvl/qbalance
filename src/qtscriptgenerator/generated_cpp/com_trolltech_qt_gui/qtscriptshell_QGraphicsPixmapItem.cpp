...
QtScriptShell_QGraphicsPixmapItem::QtScriptShell_QGraphicsPixmapItem(QGraphicsItem*  parent)
    : QGraphicsPixmapItem(parent) {}

QtScriptShell_QGraphicsPixmapItem::QtScriptShell_QGraphicsPixmapItem(const QPixmap&  pixmap, QGraphicsItem*  parent)
...
bool  QtScriptShell_QGraphicsPixmapItem::collidesWithItem(const QGraphicsItem*  other, Qt::ItemSelectionMode  mode) const
{
...
bool  QtScriptShell_QGraphicsPixmapItem::collidesWithPath(const QPainterPath&  path, Qt::ItemSelectionMode  mode) const
{
...
QVariant  QtScriptShell_QGraphicsPixmapItem::itemChange(QGraphicsItem::GraphicsItemChange  change, const QVariant&  value)
{
...
void QtScriptShell_QGraphicsPixmapItem::paint(QPainter*  painter, const QStyleOptionGraphicsItem*  option, QWidget*  widget)
{
...
bool  QtScriptShell_QGraphicsPixmapItem::sceneEventFilter(QGraphicsItem*  watched, QEvent*  event)
{
