#ifndef QTSCRIPTSHELL_QUNDOVIEW_H
#define QTSCRIPTSHELL_QUNDOVIEW_H

#include <qundoview.h>

#include <QtScript/qscriptvalue.h>

class QtScriptShell_QUndoView : public QUndoView
{
public:
    QtScriptShell_QUndoView(QUndoGroup*  group, QWidget*  parent = 0);
    QtScriptShell_QUndoView(QUndoStack*  stack, QWidget*  parent = 0);
    QtScriptShell_QUndoView(QWidget*  parent = 0);
...
#endif // QTSCRIPTSHELL_QUNDOVIEW_H
