...
class QtScriptShell_QLCDNumber : public QLCDNumber
{
public:
    QtScriptShell_QLCDNumber(QWidget*  parent = 0);
    QtScriptShell_QLCDNumber(uint  numDigits, QWidget*  parent = 0);
...
#endif // QTSCRIPTSHELL_QLCDNUMBER_H
