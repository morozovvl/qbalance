...
QtScriptShell_QStringListModel::QtScriptShell_QStringListModel(QObject*  parent)
    : QStringListModel(parent) {}

QtScriptShell_QStringListModel::QtScriptShell_QStringListModel(const QStringList&  strings, QObject*  parent)
    : QStringListModel(strings, parent) {}

QtScriptShell_QStringListModel::~QtScriptShell_QStringListModel() {}

QModelIndex  QtScriptShell_QStringListModel::buddy(const QModelIndex&  index) const
{
...
bool  QtScriptShell_QStringListModel::canDropMimeData(const QMimeData*  data, Qt::DropAction  action, int  row, int  column, const QModelIndex&  parent) const
{
...
bool  QtScriptShell_QStringListModel::canFetchMore(const QModelIndex&  parent) const
{
...
void QtScriptShell_QStringListModel::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QStringListModel::customEvent(QEvent*  arg__1)
{
...
QVariant  QtScriptShell_QStringListModel::data(const QModelIndex&  index, int  role) const
{
...
bool  QtScriptShell_QStringListModel::dropMimeData(const QMimeData*  data, Qt::DropAction  action, int  row, int  column, const QModelIndex&  parent)
{
...
bool  QtScriptShell_QStringListModel::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QStringListModel::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QStringListModel::fetchMore(const QModelIndex&  parent)
{
...
Qt::ItemFlags  QtScriptShell_QStringListModel::flags(const QModelIndex&  index) const
{
...
QVariant  QtScriptShell_QStringListModel::headerData(int  section, Qt::Orientation  orientation, int  role) const
{
...
QModelIndex  QtScriptShell_QStringListModel::index(int  row, int  column, const QModelIndex&  parent) const
{
...
bool  QtScriptShell_QStringListModel::insertColumns(int  column, int  count, const QModelIndex&  parent)
{
...
bool  QtScriptShell_QStringListModel::insertRows(int  row, int  count, const QModelIndex&  parent)
{
...
QMap<int , QVariant >  QtScriptShell_QStringListModel::itemData(const QModelIndex&  index) const
{
...
QList<QModelIndex >  QtScriptShell_QStringListModel::match(const QModelIndex&  start, int  role, const QVariant&  value, int  hits, Qt::MatchFlags  flags) const
{
...
QMimeData*  QtScriptShell_QStringListModel::mimeData(const QList<QModelIndex >&  indexes) const
{
...
QStringList  QtScriptShell_QStringListModel::mimeTypes() const
{
...
bool  QtScriptShell_QStringListModel::moveColumns(const QModelIndex&  sourceParent, int  sourceColumn, int  count, const QModelIndex&  destinationParent, int  destinationChild)
{
...
bool  QtScriptShell_QStringListModel::moveRows(const QModelIndex&  sourceParent, int  sourceRow, int  count, const QModelIndex&  destinationParent, int  destinationChild)
{
...
bool  QtScriptShell_QStringListModel::removeColumns(int  column, int  count, const QModelIndex&  parent)
{
...
bool  QtScriptShell_QStringListModel::removeRows(int  row, int  count, const QModelIndex&  parent)
{
...
void QtScriptShell_QStringListModel::revert()
{
...
QHash<int , QByteArray >  QtScriptShell_QStringListModel::roleNames() const
{
...
int  QtScriptShell_QStringListModel::rowCount(const QModelIndex&  parent) const
{
...
bool  QtScriptShell_QStringListModel::setData(const QModelIndex&  index, const QVariant&  value, int  role)
{
...
bool  QtScriptShell_QStringListModel::setHeaderData(int  section, Qt::Orientation  orientation, const QVariant&  value, int  role)
{
...
bool  QtScriptShell_QStringListModel::setItemData(const QModelIndex&  index, const QMap<int , QVariant >&  roles)
{
...
QModelIndex  QtScriptShell_QStringListModel::sibling(int  row, int  column, const QModelIndex&  idx) const
{
...
void QtScriptShell_QStringListModel::sort(int  column, Qt::SortOrder  order)
{
...
QSize  QtScriptShell_QStringListModel::span(const QModelIndex&  index) const
{
...
bool  QtScriptShell_QStringListModel::submit()
{
...
Qt::DropActions  QtScriptShell_QStringListModel::supportedDragActions() const
{
...
Qt::DropActions  QtScriptShell_QStringListModel::supportedDropActions() const
{
...
void QtScriptShell_QStringListModel::timerEvent(QTimerEvent*  arg__1)
{
