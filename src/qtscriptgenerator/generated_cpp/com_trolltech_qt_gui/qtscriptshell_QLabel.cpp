...
bool  QtScriptShell_QLabel::hasHeightForWidth() const
{
...
void QtScriptShell_QLabel::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QLabel::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QLabel::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QLabel::sharedPainter() const
{
