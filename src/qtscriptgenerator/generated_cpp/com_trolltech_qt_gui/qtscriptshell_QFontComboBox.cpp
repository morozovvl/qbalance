...
bool  QtScriptShell_QFontComboBox::hasHeightForWidth() const
{
...
void QtScriptShell_QFontComboBox::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QFontComboBox::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QFontComboBox::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QFontComboBox::sharedPainter() const
{
