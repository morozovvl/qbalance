...
static const int qtscript_QSpinBox_function_lengths[] = {
    1
    // static
    // prototype
    , 2
...
QScriptValue qtscript_create_QSpinBox_class(QScriptEngine *engine)
{
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QSpinBox_static_call, proto, qtscript_QSpinBox_function_lengths[0]);
