...
static QScriptValue qtscript_QStyleOptionViewItem_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QStyleOptionViewItem : public QStyleOptionViewItem
{

    friend QScriptValue qtscript_QStyleOptionViewItem_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QStyleOptionViewItem_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QStyleOptionViewItem* _q_self = reinterpret_cast<qtscript_QStyleOptionViewItem*>(qscriptvalue_cast<QStyleOptionViewItem*>(context->thisObject()));
    if (!_q_self) {
        return context->throwError(QScriptContext::TypeError,
