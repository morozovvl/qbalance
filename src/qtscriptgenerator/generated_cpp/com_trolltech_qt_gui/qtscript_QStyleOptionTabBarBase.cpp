...
static QScriptValue qtscript_QStyleOptionTabBarBase_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QStyleOptionTabBarBase : public QStyleOptionTabBarBase
{

    friend QScriptValue qtscript_QStyleOptionTabBarBase_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QStyleOptionTabBarBase_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QStyleOptionTabBarBase* _q_self = reinterpret_cast<qtscript_QStyleOptionTabBarBase*>(qscriptvalue_cast<QStyleOptionTabBarBase*>(context->thisObject()));
    if (!_q_self) {
