...
QtScriptShell_QGraphicsPathItem::QtScriptShell_QGraphicsPathItem(QGraphicsItem*  parent)
    : QGraphicsPathItem(parent) {}

QtScriptShell_QGraphicsPathItem::QtScriptShell_QGraphicsPathItem(const QPainterPath&  path, QGraphicsItem*  parent)
