...
void QtScriptShell_QTextEdit::doSetTextCursor(const QTextCursor&  cursor)
{
...
bool  QtScriptShell_QTextEdit::hasHeightForWidth() const
{
...
void QtScriptShell_QTextEdit::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QTextEdit::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QTextEdit::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QTextEdit::setupViewport(QWidget*  viewport)
{
...
QPainter*  QtScriptShell_QTextEdit::sharedPainter() const
{
...
QSize  QtScriptShell_QTextEdit::viewportSizeHint() const
{
