...
static QScriptValue qtscript_QStyleOptionProgressBar_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QStyleOptionProgressBar : public QStyleOptionProgressBar
{

    friend QScriptValue qtscript_QStyleOptionProgressBar_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QStyleOptionProgressBar_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QStyleOptionProgressBar* _q_self = reinterpret_cast<qtscript_QStyleOptionProgressBar*>(qscriptvalue_cast<QStyleOptionProgressBar*>(context->thisObject()));
    if (!_q_self) {
