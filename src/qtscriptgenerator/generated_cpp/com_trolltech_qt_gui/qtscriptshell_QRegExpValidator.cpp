...
QtScriptShell_QRegExpValidator::QtScriptShell_QRegExpValidator(QObject*  parent)
    : QRegExpValidator(parent) {}

QtScriptShell_QRegExpValidator::QtScriptShell_QRegExpValidator(const QRegExp&  rx, QObject*  parent)
...
bool  QtScriptShell_QRegExpValidator::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
QValidator::State  QtScriptShell_QRegExpValidator::validate(QString&  input, int&  pos) const
{
