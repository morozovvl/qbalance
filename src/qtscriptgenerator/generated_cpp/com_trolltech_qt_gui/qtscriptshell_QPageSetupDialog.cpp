...
bool  QtScriptShell_QPageSetupDialog::hasHeightForWidth() const
{
...
void QtScriptShell_QPageSetupDialog::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QPageSetupDialog::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
void QtScriptShell_QPageSetupDialog::open()
{
...
QPaintDevice*  QtScriptShell_QPageSetupDialog::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QPageSetupDialog::sharedPainter() const
{
