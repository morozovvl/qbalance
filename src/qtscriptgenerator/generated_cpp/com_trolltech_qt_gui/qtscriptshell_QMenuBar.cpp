...
QtScriptShell_QMenuBar::QtScriptShell_QMenuBar(QWidget*  parent)
    : QMenuBar(parent) {}

QtScriptShell_QMenuBar::~QtScriptShell_QMenuBar() {}

void QtScriptShell_QMenuBar::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QMenuBar::devType() const
{
...
void QtScriptShell_QMenuBar::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QMenuBar::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QMenuBar::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QMenuBar::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QMenuBar::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QMenuBar::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QMenuBar::hasHeightForWidth() const
{
...
int  QtScriptShell_QMenuBar::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QMenuBar::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QMenuBar::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QMenuBar::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QMenuBar::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QMenuBar::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QMenuBar::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QMenuBar::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QMenuBar::paintEngine() const
{
...
void QtScriptShell_QMenuBar::paintEvent(QPaintEvent*  arg__1)
{
...
QPaintDevice*  QtScriptShell_QMenuBar::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QMenuBar::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::setVisible(bool  visible)
{
    QScriptValue _q_function = __qtscript_self.property("setVisible");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("setVisible") & QScriptValue::QObjectMember)
        || (_q_function.data().toBool() == true)) {
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, visible));
        _q_function.setData(QScriptValue(false));
    }
}

QPainter*  QtScriptShell_QMenuBar::sharedPainter() const
{
...
void QtScriptShell_QMenuBar::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QMenuBar::wheelEvent(QWheelEvent*  arg__1)
{
