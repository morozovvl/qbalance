...
static QScriptValue qtscript_QGraphicsDropShadowEffect_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QGraphicsDropShadowEffect : public QGraphicsDropShadowEffect
{

    friend QScriptValue qtscript_QGraphicsDropShadowEffect_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QGraphicsDropShadowEffect_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QGraphicsDropShadowEffect* _q_self = reinterpret_cast<qtscript_QGraphicsDropShadowEffect*>(qscriptvalue_cast<QGraphicsDropShadowEffect*>(context->thisObject()));
    if (!_q_self) {
