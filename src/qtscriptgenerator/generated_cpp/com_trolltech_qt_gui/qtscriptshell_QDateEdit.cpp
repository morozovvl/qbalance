...
QtScriptShell_QDateEdit::QtScriptShell_QDateEdit(QWidget*  parent)
    : QDateEdit(parent) {}

QtScriptShell_QDateEdit::QtScriptShell_QDateEdit(const QDate&  date, QWidget*  parent)
    : QDateEdit(date, parent) {}

QtScriptShell_QDateEdit::~QtScriptShell_QDateEdit() {}

void QtScriptShell_QDateEdit::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QDateEdit::changeEvent(QEvent*  event)
{
...
void QtScriptShell_QDateEdit::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QDateEdit::clear()
{
...
void QtScriptShell_QDateEdit::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_QDateEdit::contextMenuEvent(QContextMenuEvent*  event)
{
...
void QtScriptShell_QDateEdit::customEvent(QEvent*  arg__1)
{
...
QDateTime  QtScriptShell_QDateEdit::dateTimeFromText(const QString&  text) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.setData(QScriptValue(true));
        QScriptEngine *_q_engine = __qtscript_self.engine();
        QDateTime _q_retval = qscriptvalue_cast<QDateTime >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
int  QtScriptShell_QDateEdit::devType() const
{
...
void QtScriptShell_QDateEdit::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QDateEdit::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QDateEdit::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QDateEdit::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QDateEdit::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QDateEdit::event(QEvent*  event)
{
...
bool  QtScriptShell_QDateEdit::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QDateEdit::fixup(QString&  input) const
{
...
void QtScriptShell_QDateEdit::focusInEvent(QFocusEvent*  event)
{
...
bool  QtScriptShell_QDateEdit::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QDateEdit::focusOutEvent(QFocusEvent*  event)
{
...
bool  QtScriptShell_QDateEdit::hasHeightForWidth() const
{
...
int  QtScriptShell_QDateEdit::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QDateEdit::hideEvent(QHideEvent*  event)
{
...
void QtScriptShell_QDateEdit::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QDateEdit::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QDateEdit::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QDateEdit::keyPressEvent(QKeyEvent*  event)
{
...
void QtScriptShell_QDateEdit::keyReleaseEvent(QKeyEvent*  event)
{
...
void QtScriptShell_QDateEdit::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QDateEdit::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QDateEdit::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDateEdit::mouseMoveEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QDateEdit::mousePressEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QDateEdit::mouseReleaseEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QDateEdit::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QDateEdit::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QDateEdit::paintEngine() const
{
...
void QtScriptShell_QDateEdit::paintEvent(QPaintEvent*  event)
{
...
QPaintDevice*  QtScriptShell_QDateEdit::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QDateEdit::resizeEvent(QResizeEvent*  event)
{
...
QPainter*  QtScriptShell_QDateEdit::sharedPainter() const
{
...
void QtScriptShell_QDateEdit::showEvent(QShowEvent*  event)
{
...
void QtScriptShell_QDateEdit::stepBy(int  steps)
{
...
QAbstractSpinBox::StepEnabled  QtScriptShell_QDateEdit::stepEnabled() const
{
...
void QtScriptShell_QDateEdit::tabletEvent(QTabletEvent*  arg__1)
{
...
QString  QtScriptShell_QDateEdit::textFromDateTime(const QDateTime&  dt) const
{
...
void QtScriptShell_QDateEdit::timerEvent(QTimerEvent*  event)
{
...
QValidator::State  QtScriptShell_QDateEdit::validate(QString&  input, int&  pos) const
{
...
void QtScriptShell_QDateEdit::wheelEvent(QWheelEvent*  event)
{
