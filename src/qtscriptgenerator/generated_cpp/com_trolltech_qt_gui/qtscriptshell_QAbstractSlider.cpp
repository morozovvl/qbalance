...
bool  QtScriptShell_QAbstractSlider::hasHeightForWidth() const
{
...
void QtScriptShell_QAbstractSlider::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QAbstractSlider::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QAbstractSlider::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QAbstractSlider::sharedPainter() const
{
