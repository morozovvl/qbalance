...
QtScriptShell_QPushButton::QtScriptShell_QPushButton(QWidget*  parent)
    : QPushButton(parent) {}

QtScriptShell_QPushButton::QtScriptShell_QPushButton(const QIcon&  icon, const QString&  text, QWidget*  parent)
    : QPushButton(icon, text, parent) {}

QtScriptShell_QPushButton::QtScriptShell_QPushButton(const QString&  text, QWidget*  parent)
...
bool  QtScriptShell_QPushButton::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
bool  QtScriptShell_QPushButton::hasHeightForWidth() const
{
...
void QtScriptShell_QPushButton::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QPushButton::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QPushButton::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QPushButton::sharedPainter() const
{
