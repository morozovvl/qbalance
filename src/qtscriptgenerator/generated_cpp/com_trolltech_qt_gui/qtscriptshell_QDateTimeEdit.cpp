...
bool  QtScriptShell_QDateTimeEdit::hasHeightForWidth() const
{
...
void QtScriptShell_QDateTimeEdit::initPainter(QPainter*  painter) const
{
...
QPaintDevice*  QtScriptShell_QDateTimeEdit::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QDateTimeEdit::sharedPainter() const
{
