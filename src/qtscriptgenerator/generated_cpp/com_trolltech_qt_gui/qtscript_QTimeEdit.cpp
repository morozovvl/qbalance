...
static QScriptValue qtscript_QTimeEdit_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QTimeEdit : public QTimeEdit
{

    friend QScriptValue qtscript_QTimeEdit_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QTimeEdit_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QTimeEdit* _q_self = reinterpret_cast<qtscript_QTimeEdit*>(qscriptvalue_cast<QTimeEdit*>(context->thisObject()));
    if (!_q_self) {
