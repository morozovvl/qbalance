#ifndef QTSCRIPTSHELL_QFILEDIALOG_H
#define QTSCRIPTSHELL_QFILEDIALOG_H

#include <qfiledialog.h>

#include <QtScript/qscriptvalue.h>

class QtScriptShell_QFileDialog : public QFileDialog
{
public:
...
#endif // QTSCRIPTSHELL_QFILEDIALOG_H
