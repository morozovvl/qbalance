...
QScriptValue qtscript_create_QTouchDevice_class(QScriptEngine *engine);
...
QScriptValue qtscript_create_QWindow_class(QScriptEngine *engine);
...
QScriptValue qtscript_create_QSurface_class(QScriptEngine *engine);
...
QScriptValue qtscript_create_QScreen_class(QScriptEngine *engine);
...
static const QtBindingCreator qtscript_com_trolltech_qt_gui_class_functions[] = {
    ...
    , qtscript_create_QTouchDevice_class
    , qtscript_create_QTileRules_class
    , qtscript_create_QTreeWidgetItem_class
    , qtscript_create_QLine_class
    , qtscript_create_QWindow_class
    ...
    , qtscript_create_QSurface_class
    ...
    , qtscript_create_QMatrix3x3_class
    ...
    , qtscript_create_QMatrix4x4_class
    ...
    , qtscript_create_QGuiApplication_class
