...
QtScriptShell_QColorDialog::QtScriptShell_QColorDialog(QWidget*  parent)
    : QColorDialog(parent) {}

QtScriptShell_QColorDialog::QtScriptShell_QColorDialog(const QColor&  initial, QWidget*  parent)
...
bool  QtScriptShell_QColorDialog::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
int  QtScriptShell_QColorDialog::exec()
{
...
bool  QtScriptShell_QColorDialog::hasHeightForWidth() const
{
...
void QtScriptShell_QColorDialog::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QColorDialog::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
void QtScriptShell_QColorDialog::open()
{
...
QPaintDevice*  QtScriptShell_QColorDialog::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QColorDialog::sharedPainter() const
{
