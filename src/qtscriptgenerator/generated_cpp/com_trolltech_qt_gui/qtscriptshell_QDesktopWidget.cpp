...
QtScriptShell_QDesktopWidget::QtScriptShell_QDesktopWidget()
    : QDesktopWidget() {}

QtScriptShell_QDesktopWidget::~QtScriptShell_QDesktopWidget() {}

void QtScriptShell_QDesktopWidget::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QDesktopWidget::devType() const
{
...
void QtScriptShell_QDesktopWidget::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QDesktopWidget::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QDesktopWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QDesktopWidget::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QDesktopWidget::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QDesktopWidget::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QDesktopWidget::hasHeightForWidth() const
{
...
int  QtScriptShell_QDesktopWidget::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QDesktopWidget::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QDesktopWidget::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QDesktopWidget::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QDesktopWidget::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QDesktopWidget::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QDesktopWidget::minimumSizeHint() const
{
...
void QtScriptShell_QDesktopWidget::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QDesktopWidget::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QDesktopWidget::paintEngine() const
{
...
void QtScriptShell_QDesktopWidget::paintEvent(QPaintEvent*  arg__1)
{
...
QPaintDevice*  QtScriptShell_QDesktopWidget::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QDesktopWidget::resizeEvent(QResizeEvent*  e)
{
...
QPainter*  QtScriptShell_QDesktopWidget::sharedPainter() const
{
...
void QtScriptShell_QDesktopWidget::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_QDesktopWidget::sizeHint() const
{
...
void QtScriptShell_QDesktopWidget::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QDesktopWidget::wheelEvent(QWheelEvent*  arg__1)
{
