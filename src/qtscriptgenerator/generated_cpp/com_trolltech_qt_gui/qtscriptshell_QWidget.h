#ifndef QTSCRIPTSHELL_QWIDGET_H
#define QTSCRIPTSHELL_QWIDGET_H

#include <qwidget.h>

#include <QtScript/qscriptvalue.h>

class QtScriptShell_QWidget : public QWidget
{
public:
    QtScriptShell_QWidget(QWidget*  parent = 0, Qt::WindowFlags  f = 0);
