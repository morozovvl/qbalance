...
bool  QtScriptShell_QFontDialog::eventFilter(QObject*  object, QEvent*  event)
{
...
int  QtScriptShell_QFontDialog::exec()
{
...
bool  QtScriptShell_QFontDialog::hasHeightForWidth() const
{
...
void QtScriptShell_QFontDialog::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QFontDialog::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
void QtScriptShell_QFontDialog::open()
{
...
QPaintDevice*  QtScriptShell_QFontDialog::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QFontDialog::sharedPainter() const
{
