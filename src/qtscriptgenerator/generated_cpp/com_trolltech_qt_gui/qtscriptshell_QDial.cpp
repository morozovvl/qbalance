...
bool  QtScriptShell_QDial::hasHeightForWidth() const
{
...
void QtScriptShell_QDial::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QDial::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QDial::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QDial::sharedPainter() const
{
