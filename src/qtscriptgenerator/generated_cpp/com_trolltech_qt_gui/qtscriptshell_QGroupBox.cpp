...
bool  QtScriptShell_QGroupBox::hasHeightForWidth() const
{
...
void QtScriptShell_QGroupBox::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QGroupBox::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QGroupBox::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QGroupBox::sharedPainter() const
{
