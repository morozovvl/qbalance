...
bool  QtScriptShell_QAbstractPrintDialog::hasHeightForWidth() const
{
...
void QtScriptShell_QAbstractPrintDialog::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QAbstractPrintDialog::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
void QtScriptShell_QAbstractPrintDialog::open()
{
...
QPaintDevice*  QtScriptShell_QAbstractPrintDialog::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QAbstractPrintDialog::sharedPainter() const
{
