...
static QScriptValue qtscript_QStyleOptionSizeGrip_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QStyleOptionSizeGrip : public QStyleOptionSizeGrip
{

    friend QScriptValue qtscript_QStyleOptionSizeGrip_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QStyleOptionSizeGrip_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QStyleOptionSizeGrip* _q_self = reinterpret_cast<qtscript_QStyleOptionSizeGrip*>(qscriptvalue_cast<QStyleOptionSizeGrip*>(context->thisObject()));
    if (!_q_self) {
