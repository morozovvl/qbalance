...
static QScriptValue qtscript_QStyleOptionFrame_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QStyleOptionFrame : public QStyleOptionFrame
{

    friend QScriptValue qtscript_QStyleOptionFrame_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QStyleOptionFrame_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QStyleOptionFrame* _q_self = reinterpret_cast<qtscript_QStyleOptionFrame*>(qscriptvalue_cast<QStyleOptionFrame*>(context->thisObject()));
    if (!_q_self) {
        return context->throwError(QScriptContext::TypeError,
