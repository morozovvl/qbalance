...
static QScriptValue qtscript_QApplication_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QApplication : public QApplication
{

    friend QScriptValue qtscript_QApplication_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QApplication_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QApplication* _q_self = reinterpret_cast<qtscript_QApplication*>(qscriptvalue_cast<QApplication*>(context->thisObject()));
    if (!_q_self) {
