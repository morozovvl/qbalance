...
bool  QtScriptShell_QFocusFrame::hasHeightForWidth() const
{
...
void QtScriptShell_QFocusFrame::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QFocusFrame::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QFocusFrame::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QFocusFrame::sharedPainter() const
{
