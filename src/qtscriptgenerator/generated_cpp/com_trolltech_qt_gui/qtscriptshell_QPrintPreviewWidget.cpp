...
bool  QtScriptShell_QPrintPreviewWidget::hasHeightForWidth() const
{
...
void QtScriptShell_QPrintPreviewWidget::initPainter(QPainter*  painter) const
{
...
QPaintDevice*  QtScriptShell_QPrintPreviewWidget::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QPrintPreviewWidget::sharedPainter() const
{
