...
bool  QtScriptShell_QStatusBar::hasHeightForWidth() const
{
...
void QtScriptShell_QStatusBar::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QStatusBar::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QStatusBar::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QStatusBar::sharedPainter() const
{
