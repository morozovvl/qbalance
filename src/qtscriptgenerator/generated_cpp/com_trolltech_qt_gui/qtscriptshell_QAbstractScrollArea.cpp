...
bool  QtScriptShell_QAbstractScrollArea::hasHeightForWidth() const
{
...
void QtScriptShell_QAbstractScrollArea::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QAbstractScrollArea::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QAbstractScrollArea::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QAbstractScrollArea::setupViewport(QWidget*  viewport)
{
...
QPainter*  QtScriptShell_QAbstractScrollArea::sharedPainter() const
{
...
QSize  QtScriptShell_QAbstractScrollArea::viewportSizeHint() const
{
