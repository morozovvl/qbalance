...
QtScriptShell_QGraphicsSimpleTextItem::QtScriptShell_QGraphicsSimpleTextItem(QGraphicsItem*  parent)
    : QGraphicsSimpleTextItem(parent) {}

QtScriptShell_QGraphicsSimpleTextItem::QtScriptShell_QGraphicsSimpleTextItem(const QString&  text, QGraphicsItem*  parent)
