...
static QScriptValue qtscript_QTextBlockFormat_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QTextBlockFormat : public QTextBlockFormat
{

    friend QScriptValue qtscript_QTextBlockFormat_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QTextBlockFormat_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QTextBlockFormat* _q_self = reinterpret_cast<qtscript_QTextBlockFormat*>(qscriptvalue_cast<QTextBlockFormat*>(context->thisObject()));
    if (!_q_self) {
