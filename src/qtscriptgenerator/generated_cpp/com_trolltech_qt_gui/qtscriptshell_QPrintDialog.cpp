...
bool  QtScriptShell_QPrintDialog::hasHeightForWidth() const
{
...
void QtScriptShell_QPrintDialog::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QPrintDialog::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
void QtScriptShell_QPrintDialog::open()
{
...
QPaintDevice*  QtScriptShell_QPrintDialog::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QPrintDialog::sharedPainter() const
{
