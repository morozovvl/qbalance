...
bool  QtScriptShell_QDockWidget::hasHeightForWidth() const
{
...
void QtScriptShell_QDockWidget::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QDockWidget::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QDockWidget::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QDockWidget::sharedPainter() const
{
