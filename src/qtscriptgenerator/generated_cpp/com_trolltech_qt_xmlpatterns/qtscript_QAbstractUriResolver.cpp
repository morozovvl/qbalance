...
static const int qtscript_QAbstractUriResolver_function_lengths[] = {
    1
    // static
    // prototype
    , 2
    ...
    QScriptContext *context, const char *functionName, const char *signatures)
{
    ...
    return context->throwError(QString::fromLatin1("QAbstractUriResolver::%0(): could not find a function match; candidates are:\n%1")
...
QScriptValue qtscript_create_QAbstractUriResolver_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 2; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QAbstractUriResolver_prototype_call, qtscript_QAbstractUriResolver_function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QAbstractUriResolver_static_call, proto, qtscript_QAbstractUriResolver_function_lengths[0]);
