...
void QtScriptShell_QAbstractSocket::connectToHost(const QHostAddress&  address, unsigned short  port, QIODevice::OpenMode  mode)
{
...
void QtScriptShell_QAbstractSocket::connectToHost(const QString&  hostName, unsigned short  port, QIODevice::OpenMode  mode, QAbstractSocket::NetworkLayerProtocol  protocol)
{
    QScriptValue _q_function = __qtscript_self.property("connectToHost");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("connectToHost") & QScriptValue::QObjectMember)
...
void QtScriptShell_QAbstractSocket::disconnectFromHost()
{
...
void QtScriptShell_QAbstractSocket::resume()
{
...
void QtScriptShell_QAbstractSocket::setReadBufferSize(qint64  size)
{
...
bool  QtScriptShell_QAbstractSocket::setSocketDescriptor(qintptr  socketDescriptor, QAbstractSocket::SocketState  state, QIODevice::OpenMode  openMode)
{
...
void QtScriptShell_QAbstractSocket::setSocketOption(QAbstractSocket::SocketOption  option, const QVariant&  value)
{
...
qintptr  QtScriptShell_QAbstractSocket::socketDescriptor() const
{
...
QVariant  QtScriptShell_QAbstractSocket::socketOption(QAbstractSocket::SocketOption  option)
{
...
bool  QtScriptShell_QAbstractSocket::waitForConnected(int  msecs)
{
...
bool  QtScriptShell_QAbstractSocket::waitForDisconnected(int  msecs)
{
