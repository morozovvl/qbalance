...
static QScriptValue qtscript_QUdpSocket_prototype_call(QScriptContext *, QScriptEngine *);

class qtscript_QUdpSocket : public QUdpSocket
{

    friend QScriptValue qtscript_QUdpSocket_prototype_call(QScriptContext *, QScriptEngine *);
...
static QScriptValue qtscript_QUdpSocket_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    _id &= 0x0000FFFF;
    qtscript_QUdpSocket* _q_self = reinterpret_cast<qtscript_QUdpSocket*>(qscriptvalue_cast<QUdpSocket*>(context->thisObject()));
    if (!_q_self) {
