...
2	1	2	41.1	42	Товар на складе. Учтена торговая наценка		f			\N	f	f	f	f	f	f	f	f	f	t	f		f	f	\N	\N
1	1	1	41.1	60	Товар на складе. Приход от поставщика	+	t		Накладная	f	f	f	t	f	f	f	f	f	f	t	f		f	t	\N	if (__Column_Name__ ==  "p1__сумма" && Table["p1__кол"] != 0)   Table["p1__цена"] = Table["p1__сумма"]/ Table["p1__кол"]; else   Table["p1__сумма"] = Table["p1__кол"] * Table["p1__цена"]; Table["p2__сумма"] = Table["p1__кол"] * Table["номенклатура__цена_розн"] - Table["p1__сумма"];
\.
