...
SELECT * FROM документы WHERE КОД = 707774;     
SELECT * FROM документы WHERE КОД = 707796;     
SELECT * FROM документы WHERE КОД = 707140;
SELECT * FROM документы WHERE КОД = 706759;
